...
do
  ...
  do 
     ...
     if [ $(cat nexus4.kernel.whereami.decoded | grep FORK | grep "{\"pid\":$a," | grep "tgid\":$sys_tid}" | wc -l) -gt 0 ]; then
  ...
  l=$(cat trace.$k | grep "pid\":1804,\|pid\":1805,\|pid\":1806," | grep ":$ptid}}" | tail -n1)  #"pid\":1804,\|pid\":1805,\|pid\":1806,"
