...
** Hack for libcore/dalvik/src/main/java/dalvik/system/VMDebug.java in AOSP 4.4.4-r1
...
public final class VMDebug {
    ...
    public static void startMethodTracing(String traceFileName, FileDescriptor fd, int bufferSize, int flags, boolean samplingEnabled, int intervalUs) {
        ...
        startMethodTracingFdSampling(traceFileName, fd, checkBufferSize(bufferSize), flags, samplingEnabled, intervalUs);
    }
    ...
    // David's hack to enable sampling mode 
    private static native void startMethodTracingFdSampling(String traceFileName, FileDescriptor fd, int bufferSize, int flags, boolean samplingEnabled, int intervalUs);
